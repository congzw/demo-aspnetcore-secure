...
{
    [CheckFeature(Id = ConstFeatureIds.AdminOp)]
    public class ManageController : Controller
    {
        ...
        [CheckFeature(Id = ConstFeatureIds.SuperOp)]
        ...
        [CheckFeature(Id = ConstFeatureIds.SuperOp, OverrideIds = ConstFeatureIds.AdminOp)]
